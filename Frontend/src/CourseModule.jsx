  ...
  return (
    ...
    >
      ...
      {ModuleData ? (
        ...
        >
          <SideBar
            moduleObject={ModuleData}
            currentModule={currentModule}
            onChangeSlide={changeSlide}
          />
          <Pannel
            moduleContent={ModuleData[currentModule].content}
            onNextSlide={nextSlide}
            onBackSlide={backSlide}
          />
        </div>
      ) : (
      <Loading />
...
function Pannel(props) {
  ...
  return (
    ...
    >
      <div
        className="bg-light-purple flex-1"
        style={{
          width: "60%",
          margin: "auto",
          borderRadius: "16px",
      ...
      >
        ...
        <button
          className="bg-light-purple text-dark-purple px-3 rounded-md font-palanquin font-semibold flex items-center gap-1 py-1"
          onClick={() => {
            props.onNextSlide();
          }}
        >
...
function SideBar(props) {
  return (
    <div
      className="border-primary border border-l-0 border-t-0 border-b-0 "
      style={{
        padding: "0px 16px",
        overflow: "auto",
        minWidth: "300px",
      ...
      {props.moduleObject.map((d, i) => (
        <div
          ...
          className={`text-white text-[15px] font-semibold flex  py-2 px-4 my-2 -mx-1 rounded-[12px] hover:bg-mid-purple cursor-pointer ${
            props.currentModule === i
              ? "border border-primary bg-mid-purple"
              : ""
          }`}
...
function NavBar(params) {
  return (
    <div
      className="bg-mid-purple text-white border-primary border border-l-0 border-t-0 border-r-0"
      style={{
        display: "flex",
    ...
    >
      ...
      >
        ...
        <span style={{ marginLeft: "12px", fontSize: "18px", textAlign: "" }}>
