...
function ChatBot() {
  ...
  const genAI = new GoogleGenerativeAI(
    "AIzaSyAMUABPSMqboagI-T8iv9_wqTumacsHld8"
  );
  ...
  return (
    <div className="absolute bottom-0 right-0 m-8  z-20 w-[360px] bg-primary rounded-2xl ring-[6px]  justify-end ring-mid-purple shadow-2xl shadow-extra-dark-purple">
      ...
      >
        {messages.length === 0 ? (
          <div className="h-[calc(100vh-225px)] flex flex-col items-center justify-center text-[20px] font-montserrat font-semibold ">
            ...
            <iframe className="mb-3" src="https://lottie.host/embed/3a3b3e83-1c92-4748-8b81-352a32ae0a60/vageNuhXof.json"></iframe>
          </div>
        ) : (
          <></>
        )}
